...
document.getElementById('download-resume').addEventListener('click', function() {
    try {
        ...
        fetch('Aditya_Sahni_Resume.pdf')
            ...
            .catch(error => {
                console.error('Resume not found, creating fallback download:', error);
                
                // Fallback: Create a comprehensive text version
...
• Udemy SQL Server Integration Services (SSIS) - An Introduction`;
        ...
        showToast('Please contact Aditya directly at Sahniaditya6@gmail.com for resume', 'error');
    }
});
