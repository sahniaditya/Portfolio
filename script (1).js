...
document.getElementById('download-resume').addEventListener('click', function() {
    ...
    const resumeContent = `ADITYA SAHNI - DATA ENGINEER
...
• Developed 15+ custom Power BI dashboards based on stakeholder specifications, providing actionable insights into key performance indicators (KPIs) across business units and improving decision-making.
• Implemented industry's best practices for data warehousing within the Azure Synapse environment, which optimized data retrieval processes by 40% and reduced storage redundancy by 15%.
...
• Consolidated disparate sales data sources into a centralized Oracle Cloud data warehouse, increasing data consistency and reducing reporting errors by 25%.`;
    ...
    a.href = url;
    a.download = 'Aditya_Sahni_Resume.txt';
